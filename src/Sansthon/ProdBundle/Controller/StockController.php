...
class StockController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SansthonProdBundle:Stock')->findAll();
     ...
     * @Method("POST")
     * @Template("SansthonProdBundle:Stock:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SansthonProdBundle:Stock')->find($id);
     ...
     * @Method("PUT")
     * @Template("SansthonProdBundle:Stock:edit.html.twig")
     */
